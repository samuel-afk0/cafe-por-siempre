    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">CaféDelicia</h3>
            <p className="text-gray-400">
              Disfruta del mejor café de especialidad en un ambiente acogedor y único.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="text-gray-400 space-y-2">
              ...
              <li>Email: info@cafedelicia.com</li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} CaféDelicia. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
